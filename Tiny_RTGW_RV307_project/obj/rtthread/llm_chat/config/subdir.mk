...
C_SRCS += \
../rtthread/llm_chat/config/llm_config.c 

C_DEPS += \
./rtthread/llm_chat/config/llm_config.d 

OBJS += \
./rtthread/llm_chat/config/llm_config.o 

DIR_OBJS += \
./rtthread/llm_chat/config/*.o \

DIR_DEPS += \
./rtthread/llm_chat/config/*.d \

DIR_EXPANDS += \
./rtthread/llm_chat/config/*.234r.expand \


# Each subdirectory must supply rules for building sources it contributes
rtthread/llm_chat/config/%.o: ../rtthread/llm_chat/config/%.c
